...
const TOOLS = [
  {
    path: '/ip',
    name: 'IP Checker',
    desc: 'see your public IP address and ASN info',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    path: '/cidr',
    name: 'CIDR',
    desc: 'break down a subnet into range, host count, and masks',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    path: '/bgp',
    name: 'BGP',
    desc: 'look up the ASN, prefix, and registry for any IP',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    path: '/tcp',
    name: 'TCP',
    desc: 'step through the TCP handshake and teardown, packet by packet',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    path: '/tls',
    name: 'TLS',
    desc: 'inspect TLS certificates, cipher suites, and trust chains',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    path: '/dns',
    name: 'DNS',
    desc: 'query DNS records and check propagation across global resolvers',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  return (
    <div className="page-root">
      ...
      <main className="kp-main">
        <div className="intro">
          <h1>Plumber.</h1>
          <p>A small network toolbox. Inspect IPs, DNS records, TLS certificates, BGP routes, and more.</p>
        </div>
